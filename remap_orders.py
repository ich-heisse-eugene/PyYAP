...
def plot_traces(dir_name, ordim, x_coord, orders, width_tab, aperture, view):
    ...
    for i in range(orders.shape[0]):
        ...
        ax0.plot(x_coord, np.polyval(orders[i, :], x_coord), 'g.', ms=1)
...
def remap_orders(dir_name, file_arc_spec, file_reflines, file_ap, dx, dy, dxy, view): # x_ref, y_ref,
    ...
    if err != 0:
        ...
        X, Y, XX, YY = measure_shift(img, x_arc_ref, y_arc_ref, dx, dy, dxy)
...
# ########
# dxy = 10
# file_arc_spec = "thar_041.fits"
# file_reflines = "reflines.txt"
# file_ap = "temp/traces.txt"
# dir_name = os.path.realpath(".")
# view = False
#
# remap_orders(dir_name, file_arc_spec, file_reflines, file_ap, dxy, view)
#
#
# exit(0)
